...
-- Til at populate notes, men fordi den er joined med users, så behøver ikke alle informationen at blive skrevet her :) querien for det er forneden
INSERT INTO notes (note_date, writer_id, recipient_id, written_note)
VALUES
...
from notes
join users as writer on notes.writer_id = writer.user_id
join users as recipient on notes.recipient_id = recipient.user_id;
